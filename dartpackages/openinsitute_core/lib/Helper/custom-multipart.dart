...
class Field {
  String body; 
  String contentType;
  Field(this.body, this.contentType); 
}
...
class CustomMultipartRequest extends BaseRequest {
  ...
  Stream<List<int>> _finalize(String boundary) async* {
    ...
    for (var field in fields.entries) {
      ...
      yield utf8.encode(field.value.body);
      yield line;
    }
  ...
  String _headerForField(String name, Field value) {
    var header =
        'content-disposition: form-data; content-type: ${value.contentType}; name="${_browserEncode(name)}"';
    return '$header\r\n\r\n';
  }
