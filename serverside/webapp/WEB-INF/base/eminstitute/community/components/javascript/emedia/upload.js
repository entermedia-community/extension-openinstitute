// 
// Finder -- OI-community version -- 01/2026
// community/components/javascript/emedia
//
...
$(document).ready(function () {
	...
	var apphome = siteroot + $("#application").data("finderhome");  //Use finderhome instead of apphome
